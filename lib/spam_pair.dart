...
class _SpamPairPageState extends State<SpamPairPage> {
  ...
  static String get SAVE_API_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/save-api";
static String get GET_APIS_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/apis";
static String get DELETE_API_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/delete-api";
static String get UPDATE_API_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/update-api";
static String get SPAM_HISTORY_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/spam/history";
static String get TELEGRAM_SPAM_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/spam-otp";
static String get WHATSAPP_SPAM_URL => "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/spam/whatsapp";
  ...
  Future<void> _testBackendConnection() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/health"),
