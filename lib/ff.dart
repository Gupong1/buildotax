...
class _FreeFireToolsPageState extends State<FreeFireToolsPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _getPlayerStats() async {
    ...
    try {
      final url = Uri.parse(
        'http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/get_player_stats'
  ...
  Future<void> _getPlayerPersonalShow() async {
    ...
    try {
      final url = Uri.parse(
        'http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/get_player_personal_show'
  ...
  Future<void> _searchAccountByKeyword() async {
    ...
    try {
      final url = Uri.parse(
        'http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/get_search_account_by_keyword'
