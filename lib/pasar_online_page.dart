...
class _State extends State<PasarOnlinePage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _load({bool refresh = false}) async {
    ...
    try {
      final r = await http
          .get(Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/jasapost/list?key=${widget.sessionKey}'))
    ...
    showModalBottomSheet(
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, ss) {
        ...
        Future<void> submit() async {
          ...
          try {
            final r = await http.post(
              Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/jasapost/post?key=${widget.sessionKey}'),
              headers: {'Content-Type': 'application/json'},
              body: jsonEncode({
    ...
    showModalBottomSheet(
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, ss) {
        ...
        Future<void> gen() async {
          ...
          try {
            final r = await http.post(
              Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/jasapost/generateKode?key=${widget.sessionKey}'),
              headers: {'Content-Type': 'application/json'},
