...
class _TesFuncPageState extends State<TesFuncPage> {
  ...
  try {
    final res = await http.get(
      Uri.parse(
        "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/mySender?key=${widget.sessionKey}",
      ),
...
Future<void> _sendFunction() async {
  ...
  try {
    ...
    final response = await http
        .post(
          Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/test-function'),
          headers: {
