...
class TelegramAPIService {
  ...
  static Future<Map<String, dynamic>> requestOTP({
    ...
    try {
      final response = await http.post(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/request-otp'),
  ...
  static Future<Map<String, dynamic>> verify2FA({
    ...
    try {
      final response = await http.post(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/verify-2fa'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'phone_number': phoneNumber,
  ...
  static Future<Map<String, dynamic>> verifyOTP({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/verify-otp'),
        headers: {'Content-Type': 'application/json'},
  ...
  static Future<Map<String, dynamic>> submitReport({
    ...
    try {
      final response = await http.post(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/report-profile'),
        headers: {
  ...
  static Future<Map<String, dynamic>> getUserSessions(String sessionKey) async {
    try {
      final response = await http.get(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/sessions'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $sessionKey',
        },
  ...
  static Future<Map<String, dynamic>> deleteSession({
    ...
    try {
      final response = await http.delete(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/session/$targetSessionKey'),
        headers: {
          'Content-Type': 'application/json',
  ...
  static Future<Map<String, dynamic>> checkSession(String sessionKey) async {
    try {
      final response = await http.get(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/check-session'),
        headers: {
          'Authorization': 'Bearer $sessionKey',
          'Content-Type': 'application/json',
        },
  ...
  static Future<Map<String, dynamic>> getUserReports(String sessionKey) async {
    try {
      final response = await http.get(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/my-reports'),
        headers: {
          'Authorization': 'Bearer $sessionKey',
          'Content-Type': 'application/json',
        },
  ...
  static Future<Map<String, dynamic>> logout(String sessionKey) async {
    try {
      final response = await http.delete(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/telegram/logout'),
        headers: {
          'Authorization': 'Bearer $sessionKey',
          'Content-Type': 'application/json',
        },
  ...
  static Future<Map<String, dynamic>> getSystemInfo() async {
    try {
      final response = await http.get(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/api/system/info'),
        headers: {'Content-Type': 'application/json'},
      );
