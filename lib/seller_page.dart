...
final Color cardDark = const Color(0xFF1C1C1C);
  ...
  Future<void> _create() async {
    ...
    final res = await http.get(Uri.parse(
        "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/createAccount?key=${widget.keyToken}&newUser=$u&pass=$p&day=$d"));
  ...
  Future<void> _edit() async {
    ...
    setState(() => loading = true);
    final res = await http.get(Uri.parse(
        "http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/editUser?key=${widget.keyToken}&username=$u&addDays=$d"));
    final data = jsonDecode(res.body);
    if (data['edited'] == true) {
