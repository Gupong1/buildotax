...
class _AdminPageState extends State<AdminPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  try {
    final res = await http.post(
      Uri.parse('http://panelprivatkenzxcpanelpanel.pterodactylxcz.my.id:4113/createAccount'),
      headers: {
